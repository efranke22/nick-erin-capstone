...
Given this visualization and our knowledge of history, we have a strong hunch that home age plays a strong role in lead exposure in children. But it can't be the only factor - scrolling back up to our map of identifying "high lead" census tracts in red, it is clear there are some "high lead" tracts outside MSP city limits that are comprised of newer homes. For example, 
