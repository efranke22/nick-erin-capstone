...
mod2_prediction <- mod2data %>% na.omit() %>% 
  ...
  mutate(predHighLead = case_when(probability >= 0.7~"correct",
                                  probability < 0.7~"incorrect"))
...
For future research, it might be worthwhile to investigate which census tracts are getting tested more often than others. 
