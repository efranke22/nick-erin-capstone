...
mod_sar <- spautolm(formula = HighLead~  medincomeE + medageE + propHomesBuiltPre1950 + tested, data = lead_census_clean, listw = Ww, family = "SAR")
summary(mod_sar)
BIC(mod_sar)

# fit the car model
mod_car <- spautolm(formula = HighLead~  medincomeE + medageE + propHomesBuiltPre1950 + tested, data = lead_census_clean, listw = Ww, family = "CAR")
BIC(mod_car)
```
