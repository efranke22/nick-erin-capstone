...
Furthermore among census tracts with high lead exposure, there is a specific subgroup that does not test often, meaning they test less than once per child, and also live in newer houses. This is potentially dangerous as families living in these census tracts may go on about their routine thinking living in a newer household is safe when in reality there may be other factors that contribute to high lead exposure. This is especially concerning as testing rates tend to be lower and EBLL are higher in these census tracts. For future research, it will be worthwhile to investigate which census tracts are getting tested more often than others and other observable that may capture the culture within a census tract with regards to lead levels. 
